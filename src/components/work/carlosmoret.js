			...
			<div className="container">
				...
				<div className="row pt-5 px-2">
					...
					<div className="col-6 px-1">
						<h5 className="m-0">Carlos Moret Portfolio</h5>
					</div>
					<div className="col-6 px-1">
						<h5 className="m-0">
				...
				<div className="row p-1 pt-5">
					...
					<div className="col-6 px-1">
						<h5 className="m-0">Color palette</h5>
					</div>
					<div className="col-6 px-1">
						<h5 className="m-0">
					...
					<div className="col-6 px-1">
						<h5 className="m-0">Typography</h5>
					</div>
					<div className="col-6 px-1">
						...
						<h5 className="m-0 pt-3">
							Only two sizes are used throughout the project:
						</h5>
					...
					<div className="col-6 px-1">
						<h5 className="m-0">Iconography</h5>
					</div>
					<div className="col-6 px-1">
						<h5 className="m-0">
					...
					<div className="col-6 px-1 pt-5"></div>
					<div className="col-6 px-1 pt-5">
						<span className="pr-3">
							<img
